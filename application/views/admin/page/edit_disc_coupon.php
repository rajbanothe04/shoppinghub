	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Edit Disc Coupon</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal"
					action="<?php echo base_url('disc_coupon/update_disc_by_id/' . $disc_info_by_id->id) ?>"
					method="post">
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Code<span style="color: red;">*</span>
								:</label>
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->code; ?>" class="span4 typeahead" name="code"
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Discount Name<span style="color: red;">*</span>
								:</label>
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->disc_name; ?>" class="span4 typeahead"
									name="disc_name" id="disc_id" type="text" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->disc_amount; ?>" class="span4 typeahead"
									name="disc_amount" id="disc_amount" type="text" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="fileInput">Number of uses<span
									style="color: red;">*</span> :</label>
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->no_of_uses; ?>" class="span4 typeahead"
									name="no_of_uses" id="no_of_uses" type="number" required />
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Coupon Start Date<span
									style="color: red;">*</span> :</label>
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->disc_start_date; ?>" class="span4 typeahead"
									name="disc_start_date" id="dis_st_date" type="date" />
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Coupon End Date<span
									style="color: red;">*</span> :</label>
							<div class="controls">
								<input value="<?php echo $disc_info_by_id->disc_end_date; ?>" class="span4 typeahead"
									name="disc_end_date" id="dis_nd_date" type="date" />
							</div>
						</div>
