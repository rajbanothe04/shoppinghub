            ...
            <table style="float:center;text-align:left; outline: thin solid" width="100%">
                <tbody style="padding: 5px;">
                    ...
                    <tr>
                        ...
                        <?php else if ($ord_details->dis_type === 'amount'|| $ord_details->disc_amount <= $total ): ?>
        ...
        <div class="alert-box">
            ...
            <div class="container fa-border">
                <div id="printableArea">
                    ...
                    <div>
                        <table style="float:center;text-align:left; outline: thin solid" width="90%">
                            <tbody>
                                <thead>
                                    <tr style="outline: thin solid">
                                        <th>Product Name</th>
...
$(document).ready(function() {
    ...
    $('.view-details').click(function() {
        ...
        request.done(function(record) {
            var tax = ((record.product_sales_quantity * record.product_price) * 0 / 100);
            var subtotal = (record.product_price * record.product_sales_quantity) + tax;
