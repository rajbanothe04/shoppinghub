...
class Category extends CI_Controller
{
    ...
    {
        $data                = array();
        $data['maincontent'] = $this->load->view('admin/page/add_category', '', true);
    ...
    public function manage_category()
    {
        ...
        $data['maincontent']  = $this->load->view('admin/page/manage_category', $data, true);
        $this->load->view('admin/master', $data);
    }
    ...
    public function edit_category($id)
    {
        ...
        $data['maincontent']         = $this->load->view('admin/page/edit_category', $data, true);
        $this->load->view('admin/master', $data);
    }
