        ...
        <div class="box span12">
            <div class="box-header" data-original-title>
                ...
                <div class="box-icon">
                    ...
                    <a href="<?php echo base_url('manageorder/manage_order'); ?>" class=""><i class="halflings-icon remove"></i></a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('uploads/' . $single_order_details->product_image); ?>" style="width:100px;height:100px" /></td>
                                ...
                                <td>$ <?php echo $this->cart->format_number($single_order_details->product_price * $single_order_details->product_sales_quantity) ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
