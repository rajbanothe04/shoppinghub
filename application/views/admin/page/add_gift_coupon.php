	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Gift Coupon</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				<form class="form-horizontal" action="<?php echo base_url('couponci/save_gift_coupon') ?>"
					method="post">
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Discount name<span style="color: red;">*</span>
								:</label>
							<div class="controls">
								<input class="span4 typeahead" name="disc_name" id="dis_id" type="text" required />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="fileInput">Discount Amount<span
								...
								:</label>
							<div class="controls">
								<input class="span4 typeahead" name="disc_amount" id="dis_amount" type="text"
									required />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="discount_category" required>
									<option value="Select Discount Category">Select Category</option>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Coupon Start Date<span
									style="color: red;">*</span> :</label>
							<div class="controls">
								<input class="span4 typeahead" name="dis_start_date" id="dis_st_date" type="date"
									required />
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="fileInput">Coupon End Date<span
									style="color: red;">*</span> :</label>
							<div class="controls">
								<input class="span4 typeahead" name="dis_end_date" id="dis_nd_date" type="date"
									required />
							</div>
						</div>
