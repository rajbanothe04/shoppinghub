...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('product/add_product') ?>">Add Product</a>
        </li>
    </ul>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('product/save_product'); ?>" method="post"
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="product_area" name="product_short_description" id="textarea2"
                                    rows="2"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="product_area1" name="product_long_description" id="textarea2"
                                    rows="4"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" value="0" name="product_feature" id="fileInput"
                                    type="radio" checked="true" /> Unfeature
