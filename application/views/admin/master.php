			...
			<div id="sidebar-left" class="span2" style="background-color: #2c3e50;">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo base_url('admin') ?>"><i class="icon-dashboard"></i><span
									class="hidden-tablet"> Dashboard</span></a></li>
						<!-- <li><a href="<?php echo base_url('category/add_category') ?>"><i class="icon-th"></i><span
									class="hidden-tablet"> Add Category</span></a></li> -->
						<li><a href="<?php echo base_url('category/manage_category') ?>"><i class="icon-tasks"></i><span
									class="hidden-tablet"> Manage Category</span></a></li>
						<!-- <li><a href="<?php echo base_url('brand/add_brand') ?>"><i class="icon-edit"></i><span
									class="hidden-tablet"> Add Brand</span></a></li> -->
						<li><a href="<?php echo base_url('brand/manage_brand') ?>"><i class="icon-list-alt"></i><span
									class="hidden-tablet"> Manage Brand</span></a></li>
						<!-- <li><a href="<?php echo base_url('product/add_product') ?>"><i
									class="icon-shopping-cart"></i><span class="hidden-tablet"> Add Product</span></a>
						</li> -->
						<li><a href="<?php echo base_url('product/manage_product') ?>"><i
									class="icon-eye-open"></i><span class="hidden-tablet"> Manage Product</span></a>
						</li>
						<li><a href="<?php echo base_url('manageorder/manage_order'); ?>"><i
									class="icon-calendar"></i><span class="hidden-tablet"> All Order</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo base_url("couponci/manage_gift_coupon"); ?>">
										<i class="icon-file-alt"></i><span class="hidden-tablet">Discount-Gift
											Card</span></a>
								</li>
								<li><a class="submenu"
										href="<?php echo base_url("disc_coupon/manage_discount_coupon"); ?>">
										<i class="icon-file-alt"></i><span
											class="hidden-tablet">Discount-Referrals</span></a>
								</li>
							</ul>
						</li>
