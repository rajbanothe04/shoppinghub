...
<div id="content" class="span10">
	...
	<ul class="breadcrumb">
		...
		<li>
			<i class="icon-edit"></i>
			<a href="<?php echo base_url('brand/add_brand') ?>">Add Brand</a>
		</li>
	</ul>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
				<form class="form-horizontal" action="<?php echo base_url('brand/save_brand') ?>" method="post">
					<fieldset>
						...
						<div class="form-actions">
							...
							<?= anchor('brand/manage_brand', 'Cancel', ['class' => 'btn btn-danger']); ?>
						</div>
					</fieldset>
				</form>
