...
<div id="content" class="span10">
	...
	<ul class="breadcrumb">
		...
		<li><a href="<?php echo base_url('brand/manage_brand') ?>">Manage Brand</a></li>
	</ul>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<?= anchor("brand/add_brand", '+ Add Brand', ['class' => 'btn btn-success']); ?>
						...
						<tr>
							...
							<td class="center">
								...
								<a class="btn btn-success"
									href="<?php echo base_url('brand/published_brand/' . $single_brand->brand_id); ?>">
									<i class="halflings-icon white thumbs-up"></i>
								</a>
								<?php } else {
									?>
								<a class="btn btn-danger"
									href="<?php echo base_url('brand/unpublished_brand/' . $single_brand->brand_id); ?>">
								...
								<a class="btn btn-info"
									href="<?php echo base_url('brand/edit_brand/' . $single_brand->brand_id); ?>">
									<i class="halflings-icon white edit"></i>
								</a>
								<a class="btn btn-danger"
									href="<?php echo base_url('brand/delete_brand/' . $single_brand->brand_id); ?>">
