...
class Product extends CI_Controller
{
    ...
    public function add_product()
    {
        ...
        $data['maincontent']            = $this->load->view('admin/page/add_product', $data, true);
    ...
    public function manage_product()
    {
        ...
        $data['maincontent']     = $this->load->view('admin/page/manage_product', $data, true);
        $this->load->view('admin/master', $data);
    }
    ...
    public function edit_product($id)
    {
        ...
        $data['maincontent']            = $this->load->view('admin/page/edit_product', $data, true);
        $this->load->view('admin/master', $data);
    }
