...
class Brand extends CI_Controller
{
    ...
    {
        $data                = array();
        $data['maincontent'] = $this->load->view('admin/page/add_brand', '', true);
    ...
    public function manage_brand()
    {
        ...
        $data['maincontent'] = $this->load->view('admin/page/manage_brand', $data, true);
        $this->load->view('admin/master', $data);
    }
    ...
    public function edit_brand($id)
    {
        ...
        $data['maincontent']      = $this->load->view('admin/page/edit_brand', $data, true);
        $this->load->view('admin/master', $data);
    }
