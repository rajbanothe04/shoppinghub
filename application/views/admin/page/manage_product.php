...
<div id="content" class="span10">
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<?= anchor("product/add_product", '+ Add Product', ['class' => 'btn btn-success']); ?>
						...
						<tr>
							...
							<td class="center">
								...
								<a class="btn btn-success"
									href="<?php echo base_url('product/published_product/' . $single_product->product_id); ?>">
									<i class="halflings-icon white thumbs-up"></i>
								</a>
								<?php } else {
                                    ?>
								<a class="btn btn-danger"
									href="<?php echo base_url('product/unpublished_product/' . $single_product->product_id); ?>">
								...
								<a class="btn btn-info"
									href="<?php echo base_url('product/edit_product/' . $single_product->product_id); ?>">
									<i class="halflings-icon white edit"></i>
								</a>
								<a class="btn btn-danger"
									href="<?php echo base_url('product/delete_product/' . $single_product->product_id); ?>">
