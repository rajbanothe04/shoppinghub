...
<div id="content" class="span10">
	...
	<ul class="breadcrumb">
		...
		<li>
			<i class="icon-edit"></i>
			<a href="<?php echo base_url('product/edit_product/' . $product_info_by_id->product_id) ?>">edit Product</a>
		</li>
	</ul>
		...
		<div class="box span12">
			<div class="box-header" data-original-title>
				...
				<div class="box-icon">
					...
					<a href="<?php echo base_url('product/manage_product'); ?>" class=""><i
			...
			<div class="box-content">
				<form name="formName" class="form-horizontal"
					action="<?php echo base_url('product/update_product/' . $product_info_by_id->product_id); ?>"
					...
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="span6 typeahead" value="<?php echo $product_info_by_id->product_title; ?>"
									name="product_title" id="fileInput" type="text" />
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input class="span6 typeahead" name="product_delete_image"
									value="<?php echo base_url('uploads/' . $product_info_by_id->product_image); ?>"
									type="hidden" />
							</div>
						</div>
						...
						<div class="control-group">
							<div class="controls">
								<img src="<?php echo base_url('uploads/' . $product_info_by_id->product_image); ?>"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="span6 typeahead" value="<?php echo $product_info_by_id->product_price; ?>"
									name="product_price" id="fileInput" type="text" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="span6 typeahead"
									value="<?php echo $product_info_by_id->product_quantity; ?>" name="product_quantity"
									id="fileInput" type="text" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="product_brand" name="product_brand">
									...
									<option value="<?php echo $single_brand->brand_id; ?>">
										<?php echo $single_brand->brand_name; ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="span6 typeahead" value="0" name="product_feature" id="fileInput"
									type="radio" /> Unfeatured
								<input class="span6 typeahead" value="1" name="product_feature" id="fileInput"
									type="radio" />Featured
							</div>
						</div>
