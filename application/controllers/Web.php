...
class Web extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('web/page/home', $data);
    ...
    public function contact()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/contact');
        $this->load->view('web/inc/footer');
    }
    ...
    public function cart()
    {
        ...
        $this->load->view('web/inc/header');
        $this->load->view('web/page/cart', $data);
        $this->load->view('web/inc/footer');
    }
    ...
    public function product()
    {
        ...
        $this->load->view('web/inc/header');
        $this->load->view('web/page/product', $data);
        $this->load->view('web/inc/footer');
    }
    ...
    public function single($id)
    {
        ...
        $this->load->view('web/inc/header');
        $this->load->view('web/page/single', $data);
        $this->load->view('web/inc/footer');
    }
    ...
    public function register_success()
    {
        ...
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/register_success');
        $this->load->view('web/inc/footer');
    }
    ...
    public function user_form()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/user_form');
        $this->load->view('web/inc/footer');
    }
    ...
    public function customer_register()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/customer_register');
        $this->load->view('web/inc/footer');
    }
    ...
    public function customer_login()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/customer_login');
        $this->load->view('web/inc/footer');
    }
    ...
    public function customer_shipping()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/customer_shipping');
        $this->load->view('web/inc/footer');
    }
    ...
    public function checkout()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/checkout');
        $this->load->view('web/inc/footer');
    }
    ...
    public function payment()
    {
        $data = array();
        $this->load->view('web/inc/header');
        $this->load->view('web/page/payment');
        $this->load->view('web/inc/footer');
    }
    ...
    public function pdf($order_id)
    {
        ...
        $this->pdf->load_view('admin/page/pdf', $data);
    ...
    public function search()
    {
        ...
        if (!empty($search)) {
            ...
            if ($data['get_all_product']) {
                $this->load->view('web/inc/header');
                $this->load->view('web/page/search', $data);
                $this->load->view('web/inc/footer');
            } else {
                redirect('error');
            }
