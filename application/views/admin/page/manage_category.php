...
<div id="content" class="span10">
	...
	<ul class="breadcrumb">
		...
		<li><a href="<?php echo base_url('category/manage_category') ?>">Manage Category</a></li>
	</ul>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<?= anchor("category/add_category", '+ Add Category', ['class' => 'btn btn-success']); ?>
						...
						<tr>
							...
							<td class="center">
								...
								<a class="btn btn-success"
									href="<?php echo base_url('category/published_category/' . $single_category->id); ?>">
								...
								<a class="btn btn-danger"
									href="<?php echo base_url('category/delete_category/' . $single_category->id); ?>">
