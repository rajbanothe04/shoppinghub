<?php include("inc/primary_header.php") ?>
<?php include("inc/secondary_header.php") ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<title>Shopping-Hub | User Registration</title>
	...
	<div class="row">
		...
		<div class="row col-lg-6 border shadow mb-5 bg-black">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="form-group">
						<label for="state-list" class="form-label mt-4">Select State
